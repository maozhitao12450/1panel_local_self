...
if __name__ == '__main__':
    print('DingTalk is running...')
    print("TAWK_DINGDING_PORT:", os.getenv('TAWK_DINGDING_PORT'))
    print("TAWK_DINGDING_URL:", os.getenv('TAWK_DINGDING_URL'))
    print("TAWK_DINGDING_SIGN:", os.getenv('TAWK_DINGDING_SIGN'))
